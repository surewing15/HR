@php
    $user = ['type' => 'employee', 'name' => '', 'email' => ''];
@endphp
<div class="nk-header nk-header-fixed is-light" style="border-top: 10px solid #c38522">
                    ...
                    <li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                <div class="user-avatar sm" style="background-color: #c38522">
