...
@section('content')
    ...
    <div class="nk-block-head-content">
        <div class="nk-block-des text-soft">
            <p>Fill out the form below to request a Certificate of Employment.</p>
        </div>
    </div>
                            ...
                            <td class="col-lg-7">
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control" id="inp_position" name="inp_position"
                                        placeholder="Enter Position here..." value="{{ old('inp_position') }}">
                                </div>
                            </td>
                        </tr>
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="ern_text" name="ern_text"
                                            placeholder="Enter compensation (text)" value="{{ old('ern_text') }}">
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="ern_digits" name="ern_digits"
                                            placeholder="Enter compensation (digits)" value="{{ old('ern_digits') }}">
                                    </div>
                                </div>
                            </td>
                        </tr>
