                ...
                <div class="nk-content-body">
                    ...
                    <div class="nk-block">
                        <div class="row g-gs">
                                    ...
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            <div class="card-title">
                                                <h6 class="title">Total No. of Employee</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xxl-5 col-lg-6" style="width: 50%;">
                            ...
                            <div class="nk-block">
                                <div class="row g-gs">
                                                ...
                                                <div class="card-inner">
                                                    ...
                                                    <div class="data">
                                                        <div class="data-group">
                                                            <a href="/addemployees">
                                                                <span>
                                                                <span class="amount" style="font-size: 2em;">5490</span>
                                                                </span>
                                                            </a>
                                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="nk-ecwg nk-ecwg6">
                                                <div class="card-inner">
                                                    <div class="card-title-group">
                                                        <div class="card-title">
                                                            <h6 class="title">Total Faculties</h6>
                                                        </div>
                                                    </div>
                                                    <div class="data">
                                                        <div class="data-group">
                                    ...
                                    <div class="col-xxl-3 col-sm-10">
                                        <div class="card">
                                            <div class="nk-ecwg nk-ecwg">
                                                <div class="card-inner">
                                                    <div class="card-title-group">
                                                        <div class="card-title">
                                                            <h6 class="title">Total Staffs</h6>
                                                        </div>
                                                    </div>
                                                    <div class="data">
                                                        <div class="data-group">
                                        ...
                                        <div class="card">
                                            <div class="nk-ecwg nk-ecwg6">
                                                <div class="card-inner">
                                                    <div class="card-title-group">
                                                        <div class="card-title">
                                                            <h6 class="title">Pending request COE </h6>
                                                        </div>
                                                    </div>
                                                    <div class="data">
                                                        <div class="data-group">
