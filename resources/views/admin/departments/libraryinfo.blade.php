...
@section('content')
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h4 class="nk-block-title">Department of Library Information Science</h4>
                <div class="nk-block-des">
                    <p>List of employees in the College of Library Information Science.</p>
                </div>
            </div>
        </div>
    ...
    <script>$('.datatable-init-export').DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                extend: 'excelHtml5',
