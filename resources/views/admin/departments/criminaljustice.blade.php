    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h4 class="nk-block-title">Department of Criminal Justice & Public Safety</h4>
                <div class="nk-block-des">
                    <p>List of employees in the College of Criminal Justice & Public Safety.</p>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                            <ul class="link-list-plain">
                                                <li><a href="#">View</a></li>
                                                <li><a href="#">Edit</a></li>
                                                <li><a href="#" id="remove-link">Remove</a></li>
                                                    <script>
                                                    document.getElementById("pages.departments.criminaljustice").onclick = null;
                                                    </script>
                                            </ul>
                                        </div>
                                    </div>
