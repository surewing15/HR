                                ...
                                @foreach ($requests as $key => $request)
                                    <tr style="cursor: pointer">
                                        ...
                                        <td class="nk-tb-col text-center">
                                            <a href="javascript:void(0);" class="btn btn-primary my-3 text-white"
                                                onclick="openModal('{{ $request->FirstName }} {{ $request->LastName }}',
                                                '{{ $request->Position }}',
                                                '{{ $request->DateStarted }}',
                                                '{{ $request->MonthlyCompensationText }}',
                                                '{{ $request->MonthlyCompensationDigits }}')"
                                                title="View Certificate of Employment">
                                                View
                                            </a>
                                        </td>
                                    </tr>
