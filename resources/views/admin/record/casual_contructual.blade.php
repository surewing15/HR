...
<div class="container">
    <h5>LIST OF CASUAL/CONTRACTUAL PERSONNEL</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('contractuals.save') }}" method="POST">
                        @csrf
        ...
        <table class="datatable-init-export nowrap table" data-export-title="Export">
            ...
            @foreach ($contractuals as $contractual)
                <tr>
                    ...
                    <td>{{ $contractual->masterlist->last_name }} </td>
                    <td>{{ $contractual->masterlist->first_name }}</td>
                    <td>{{ $contractual->date }}</td>
                    <td>{{ $contractual->sex }}</td>
                    <td>{{ $contractual->eligibility }}</td>
                    <td>{{ $contractual->workstatus }}</td>
                    <td>{{ $contractual->yearsofservice }}</td>
                    <td>{{ $contractual->natureofwork }}</td>
                    <td>{{ $contractual->specificnatureofwork }}</td>
                </tr>
            @endforeach
        </tbody>
        </table>
