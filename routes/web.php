...
Route::middleware([
    ...
    Route::middleware(['auth', 'checkAdmin'])->group(function () {
        ...
        Route::get('/admin/addemployees', [AdminController::class, 'addEmployees'])->name('admin.addemployees');
        Route::get('/admin/dashboard', [AdminController::class, 'dashboard'])->name('admin.dashboard');
        Route::get('/admin/departments', [AdminController::class, 'departments'])->name('admin.departments');
        Route::get('/admin/others', [AdminController::class, 'others'])->name('admin.others');
